...
The treatments with the smallest group size are surrounding cell and epithelium of utricle combination and sensory hair cell and sensory epithelium of spiral organ combination. Now we filter the genes with CPM > 1 in thses two groups and all genes in the rest treatment groups. 
```{r}
